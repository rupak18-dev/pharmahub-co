...
router.post("/data/sales/upload", authorize("reports", "create"), runUpload(uploadBillImage), reportDataController.uploadSalesBill);
router.post("/data/sales/validate-import", authorize("reports", "create"), reportDataController.validateSalesImport);
router.post("/data/sales/import", authorize("reports", "create"), reportDataController.importSalesBills);
...
router.delete("/data/sales/:id", authorize("reports", "delete"), reportDataController.deleteSalesBill);
...
router.post("/data/purchases/upload", authorize("reports", "create"), runUpload(uploadBillImage), reportDataController.uploadPurchaseDocument);
router.post("/data/purchases/validate-import", authorize("reports", "create"), reportDataController.validatePurchaseImport);
router.post("/data/purchases/import", authorize("reports", "create"), reportDataController.importPurchases);
...
router.put("/data/purchases/:id", authorize("reports", "update"), reportDataController.updatePurchase);
router.delete("/data/purchases/:id", authorize("reports", "delete"), reportDataController.deletePurchase);
// Read-only listing for the other report data sources.
// The unified bills manager routes must stay ABOVE /data/:source.
router.get("/data/bills/summary", authorize("reports", "view"), reportDataController.getReportBillsSummary);
...
router.post("/data/bills/:id/whatsapp", authorize("reports", "create"), reportDataController.sendReportBillWhatsApp);
router.post("/data/bills/:id/whatsapp/retry", authorize("reports", "create"), reportDataController.retryReportBillWhatsApp);
router.put("/data/bills/:id", authorize("reports", "update"), reportDataController.updateReportBill);
router.delete("/data/bills/:id", authorize("reports", "delete"), reportDataController.deleteReportBill);
