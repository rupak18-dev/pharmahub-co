...
router.post("/invitations/accept", validate(userSchemas.acceptInvitation), userController.acceptInvitation);
...
router.post("/invite", authorize("users", "create"), validate(userSchemas.invite), userController.inviteUser);
