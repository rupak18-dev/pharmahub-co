...
const F = {
  ...
  customerPhone: { key: "customerPhone", label: "Customer Phone" },
  medicine: { key: "medicine", label: "Medicine" },
  category: { key: "category", label: "Category" },
  invoice: { key: "invoice", label: "Bill Number" },
  ...
  paymentStatus: { key: "paymentStatus", label: "Payment Status" },
  ...
  supplierGstin: { key: "supplierGstin", label: "Supplier GSTIN" },
  batch: { key: "batch", label: "Batch" },
  batchNumber: { key: "batchNumber", label: "Batch Number" },
  pack: { key: "pack", label: "Pack" },
  manufacturer: { key: "manufacturer", label: "Manufacturer" },
  documentType: { key: "documentType", label: "Document Type" },
...
const M = {
  ...
  subtotal: { key: "subtotal", label: "Subtotal", money: true },
  grandTotal: { key: "grandTotal", label: "Grand Total", money: true },
  unitPrice: { key: "unitPrice", label: "Unit Price", money: true },
  ...
  totalGst: { key: "totalGst", label: "Total GST", money: true },
  totalSGST: { key: "totalSGST", label: "Total SGST", money: true },
  totalCGST: { key: "totalCGST", label: "Total CGST", money: true },
...
export const REPORT_MODULES = [
  ...
  },
  {
    ...
    category: "GST",
    description:
      "Taxable turnover and tax liability by GST slab and HSN code, across sales and purchase invoices.",
    icon: Landmark,
    dateField: "Bill Date",
    defaultDatePreset: "month",
    fields: [
...
const MEASURE_SUFFIX = {
  ...
  grandTotal: "Sales Report",
  unitPrice: "Price Report",
  ...
  totalGst: "Purchase GST Summary",
  totalSGST: "SGST Summary",
  totalCGST: "CGST Summary",
