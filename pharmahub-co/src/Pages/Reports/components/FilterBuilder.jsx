                ...
                filter.operator === "between" ? (
                  <div className="flex items-center gap-1 flex-[2] min-w-0">
                    <DatePicker.RangePicker
                      ...
                      allowClear
                      value={
                        (filter.value || "").split(",")[0] || (filter.value || "").split(",")[1]
                          ? [
                              (filter.value || "").split(",")[0]
                                ? dayjs((filter.value || "").split(",")[0], "YYYY-MM-DD")
                                : null,
                              (filter.value || "").split(",")[1]
                                ? dayjs((filter.value || "").split(",")[1], "YYYY-MM-DD")
                                : null,
                            ]
                          : null
                      }
                  ...
                  <DatePicker
                    ...
                    onChange={(d) =>
                      updateFilter(filter.id, { value: d ? d.format("YYYY-MM-DD") : "" })
                    }
                  />
                )
              ) : fieldType === "number" ? (
