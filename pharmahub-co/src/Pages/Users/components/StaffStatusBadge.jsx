...
export const STAFF_STATUS = {
  ...
  accepted: {
    ...
    variant: "secondary",
    className:
      "bg-emerald-500/10 text-emerald-700 border border-emerald-500/20 font-medium text-[10px] py-0",
    dot: "bg-emerald-500",
  },
  expired: {
    label: "Expired",
    variant: "secondary",
    className: "bg-rose-50 text-rose-600 border border-rose-200/80 font-medium text-[10px] py-0",
    dot: "bg-rose-400",
  },
  cancelled: {
    label: "Cancelled",
    variant: "secondary",
    className:
      "bg-muted text-muted-foreground border border-border/80 font-medium text-[10px] py-0 line-through",
    dot: "bg-muted-foreground",
  },
  removed: {
    label: "Removed",
    variant: "secondary",
    className: "bg-muted text-muted-foreground border border-border/80 font-medium line-through",
    dot: "bg-muted-foreground",
  },
};
