...
export function StaffAccessPanel() {
  ...
  // the exact same source UsersTab uses, so Staff Access can never disagree
  // with the Users list. Local profiles are only an offline fallback.
  ...
  const status = loadingRemote ? "loading" : loadError ? "error" : "loaded";
  const refresh = loadRemote;
