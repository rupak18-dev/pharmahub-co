...
export const INTEGRATIONS = [
  {
    ...
    capabilities: ["Bill Delivery", "Invoice Messages", "Delivery Notifications"],
    icon: SiWhatsapp,
    color: "#25D366",
    configFields: [
      {
  ...
  },
  {
    ...
    name: "Gmail",
    category: "communication",
    description: "Send invoices, reports and notifications from your organization's Gmail account.",
