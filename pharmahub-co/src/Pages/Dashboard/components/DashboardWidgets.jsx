    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
      ...
      <div className="rounded-2xl border border-border bg-card shadow-sm flex flex-col">
        <div className="flex items-center justify-between border-b border-border px-4 py-3">
          ...
          <Link to="/sales" className="text-xs font-medium text-blue-600 hover:underline">
            View all
          </Link>
        </div>
      ...
      <div className="rounded-2xl border border-border bg-card shadow-sm flex flex-col">
        <div className="flex items-center justify-between border-b border-border px-4 py-3">
          ...
          <Link to="/purchases" className="text-xs font-medium text-violet-600 hover:underline">
            View all
          </Link>
        </div>
        <div className="p-0 flex-1">
      ...
      <div className="rounded-2xl border border-border bg-card shadow-sm flex flex-col">
        <div className="flex items-center justify-between border-b border-border px-4 py-3">
          ...
          <Link to="/inventory" className="text-xs font-medium text-amber-600 hover:underline">
            View all
          </Link>
        </div>
        <div className="p-0 flex-1">
      ...
      <div className="rounded-2xl border border-border bg-card shadow-sm flex flex-col">
        <div className="flex items-center justify-between border-b border-border px-4 py-3">
          ...
          <Link to="/expiry" className="text-xs font-medium text-rose-600 hover:underline">
            View all
          </Link>
        </div>
        <div className="p-0 flex-1">
