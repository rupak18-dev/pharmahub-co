    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "/profile/integrations", lazy: lazyPage(() => import("@/Pages/Integrations/IntegrationsPage")) },
          { path: "/settings", lazy: lazyPage(() => import("@/Pages/Settings/SettingsPage")) },
          { path: "/organizations", lazy: lazyPage(() => import("@/Pages/Organizations/OrganizationsPage")) },
          { path: "/security", lazy: lazyPage(() => import("@/Pages/Security/SecurityPage")) },
