...
import { BRANCHES, SCHEME_OPTIONS, suggestedDiscountPct } from "@/lib/expiry";
export function ReturnDialog({ row, open, onOpenChange, onConfirm, currency, supplierName }) {
...
export function DiscountDialog({ row, open, onOpenChange, onConfirm, currency }) {
...
export function TransferDialog({ row, open, onOpenChange, onConfirm, currency }) {
