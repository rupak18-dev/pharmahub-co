...
import type { AuditType, Batch, Category, Medicine, Profile } from "@/lib/types";
...
export function CreateAuditSheet({
  ...
  profiles: Profile[];
  branches: string[];
  onSubmit: (input: CreateAuditInput) => void;
}) {
      ...
      <SheetContent className="flex w-full max-w-full sm:max-w-xl flex-col overflow-y-auto p-4 sm:p-6">
        ...
        <div className="flex-1 space-y-5 py-4">
          <div className="space-y-2">
            ...
            <Select value={type} onValueChange={(v) => setType(v as AuditType)}>
