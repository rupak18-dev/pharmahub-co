    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="relative flex h-full w-full flex-col bg-sidebar overflow-hidden group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
