...
const ACTION_GROUPS: { groupName: string; description: string; actions: GroupedAction[] }[] = [
  {
...
export function AccessPolicyBuilder({
  ...
  const getModuleActiveCount = (modKey: ModuleKey) => {
  ...
  const togglePermission = (actionKey: PermissionAction) => {
    if (isOwner) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex flex-col text-left">
                          ...
                          <span
                            className={`text-[10px] ${
                              isEnabled ? "text-primary-foreground/80" : "text-muted-foreground"
                            }`}
                          >
                            {act.key}
                          </span>
