...
export const PerformanceCard = ({ title, value, subtext, icon: Icon, color = 'blue' }) => {
  const colorStyles = {
  ...
  return (
    ...
    >
      <div>
        ...
        <h3 className="text-xl font-extrabold text-slate-900 dark:text-white tracking-tight mt-0.5 font-mono">
          {value}
        </h3>
        {subtext && (
