...
export const PROFILE_FIELD_SPEC = [
  ...
  { key: "orgName", label: "Pharma Name", section: "studio-info" },
  { key: "tagline", label: "Pharma Tagline", section: "studio-info" },
  { key: "description", label: "Pharma Description", section: "studio-info" },
